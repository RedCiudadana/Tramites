                  ...
                  <div className="space-y-3 mb-4">
                    <div className="flex items-start space-x-2">
                      ...
                      <p className="text-blue-800 text-sm">
                        <strong>Documentos vigentes:</strong> Asegúrate de que todos los documentos requeridos estén vigentes y en buen estado
                      </p>
                    </div>
                    ...
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" />
                      <p className="text-blue-800 text-sm">
                        <strong>Tiempos estimados:</strong> Los tiempos pueden variar según la demanda y la época del año
                      </p>
                    </div>
                    ...
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" />
                      <p className="text-blue-800 text-sm">
                        <strong>Horarios de atención:</strong> Verifica los horarios antes de tu visita, pueden cambiar por días festivos
                      </p>
                    </div>
                    ...
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" />
                      <p className="text-blue-800 text-sm">
                        <strong>Costos actualizados:</strong> Los aranceles pueden cambiar, consulta los costos actuales en el portal oficial
                      </p>
                    </div>
                    ...
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" />
                      <p className="text-blue-800 text-sm">
                        <strong>Copias y originales:</strong> Lleva siempre documentos originales y copias adicionales por seguridad
                      </p>
                    </div>
                  </div>

                  {/* Conditional message for digital procedures */}
                  {procedure.isDigital && (
                    <div className="bg-blue-600 rounded-lg p-4 mt-4">
                      <div className="flex items-start space-x-3">
                        <Globe className="h-5 w-5 text-blue-100 mt-0.5 flex-shrink-0" />
                        <div>
                          <h4 className="font-semibold text-white mb-2">💻 Trámite Digital Disponible</h4>
                          <p className="text-blue-100 text-sm">
                            Este trámite puede realizarse completamente en línea. Te recomendamos usar el portal oficial 
                            para mayor comodidad y rapidez. Asegúrate de tener una conexión estable a internet y 
