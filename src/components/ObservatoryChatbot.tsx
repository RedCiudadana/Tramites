  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Total de trámites</span>
                  <span className="font-semibold text-gray-900">20</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Trámites personales</span>
                  <span className="font-semibold text-blue-600">10</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Trámites de negocios</span>
                  <span className="font-semibold text-green-600">10</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Trámites digitales</span>
                  <span className="font-semibold text-purple-600">{keyProcedures.filter(p => p.isDigital).length}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="space-y-2">
                {[
                  { id: 'all', label: 'Todos los trámites', count: keyProcedures.length, icon: Globe },
                  { id: 'personal', label: 'Trámites personales', count: keyProcedures.filter(p => p.category === 'personal').length, icon: User },
                  { id: 'business', label: 'Trámites de negocios', count: keyProcedures.filter(p => p.category === 'business').length, icon: Building2 }
                ].map((category) => {
            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-6 border border-green-100">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Hecho con ❤️ para Guatemala</h3>
              </div>
              <p className="text-sm text-gray-700 mb-4">
                Este asistente tiene información actualizada sobre los 20 trámites más importantes de Guatemala, 
                recopilada con amor por Red Ciudadana.
              </p>
        ...
        <div id="success-stories" className="mt-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Historias que Inspiran
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Cada trámite completado es una historia de éxito. Conoce cómo otros guatemaltecos 
              han logrado sus objetivos con la información correcta.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {keyProcedures
              ...
              .slice(0, 6)
              .map((procedure) => (
                <div key={procedure.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        procedure.category === 'personal' 
                          ? 'bg-blue-100 text-blue-800' 
                          : 'bg-purple-100 text-purple-800'
                      }`}>
                        {procedure.category === 'personal' ? 'Personal' : 'Negocio'}
                      </span>
                    </div>
                  </div>
                  
                  <div className="mb-4">
                    <h4 className="font-medium text-gray-900 mb-2">Historia de Éxito:</h4>
                  ...
                  <div className="space-y-2 text-xs text-gray-600 mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>{procedure.popularity}% popularidad</span>
                    </div>
                  </div>
                  
                  <button 
                    onClick={() => {
                      const message = `Información sobre ${procedure.name}`;
        ...
        <div className="mt-16 bg-blue-50 rounded-xl p-8 border border-blue-100">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-blue-900 mb-4">
              Información Verificada por Red Ciudadana
            </h3>
            <p className="text-blue-800 mb-6 max-w-3xl mx-auto">
              Todos los datos de este asistente han sido recopilados y verificados por nuestro equipo de investigación ciudadana. 
              La información se actualiza constantemente para asegurar su precisión y utilidad.
            </p>
            <div className="grid md:grid-cols-3 gap-6 text-sm">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-blue-900 mb-1">Fuentes Oficiales</h4>
                <p className="text-blue-700">Información directa de instituciones gubernamentales</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-100 p-3 rounded-xl w-12 h-12 mx-auto mb-3 flex items-center justify-center">
                  <Users className="h-6 w-6 text-blue-600" />
                </div>
                <h4 className="font-semibold text-blue-900 mb-1">Experiencia Ciudadana</h4>
                <p className="text-blue-700">Consejos basados en experiencias reales</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-100 p-3 rounded-xl w-12 h-12 mx-auto mb-3 flex items-center justify-center">
                  <Lightbulb className="h-6 w-6 text-blue-600" />
                </div>
                <h4 className="font-semibold text-blue-900 mb-1">Actualización Constante</h4>
                <p className="text-blue-700">Información revisada y actualizada regularmente</p>
              </div>
            </div>
          </div>
        </div>
