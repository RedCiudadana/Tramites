...
interface ProcedureDetailProps {
  procedure: Procedure;
  onBack: () => void;
  onStartProcedure: (procedure: Procedure) => void;
...
export default function ProcedureDetail({ procedure, onBack, onStartProcedure, onSectionChange }: ProcedureDetailProps) {
  ...
  const handleStartProcedure = () => {
    ...
    window.open('https://mingob.gob.gt', '_blank');
  };
